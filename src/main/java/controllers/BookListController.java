...
public class BookListController implements Serializable {
    ...
    private List<BookEntity> currentBookList; // текущий список книг для отображения
    ...
    public void cancelEditMode() {
        editModeView = false;
        for (BookEntity book : currentBookList) {
            book.setEdit(false);
        }
    }
    //</editor-fold>
...
//        fillBooksBySQL(currentSqlNoLimit);
    ...
    public List<BookEntity> getCurrentBookList() {
